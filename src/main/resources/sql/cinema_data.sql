...
insert into showtime(movie_id, hall_id, date, start_time, type, created_by)
    value
    ###HALL 1 & MOVIE 2-6
    (2, 1, '2026-07-03', '08:00:00', 'Phụ đề tiếng Việt', 'admin'),
    (3, 1, '2026-07-03', '10:00:00', 'Phụ đề tiếng Việt', 'admin'),
    (4, 1, '2026-07-03', '12:00:00', 'Lòng tiếng', 'admin'),
    (5, 1, '2026-07-03', '14:00:00', 'Phụ đề tiếng Anh', 'admin'),
    (6, 1, '2026-07-03', '16:00:00', 'Phụ đề tiếng Việt', 'admin'),
    (2, 1, '2026-07-03', '18:00:00', 'Phụ đề tiếng Việt', 'admin'),
    (3, 1, '2026-07-03', '20:00:00', 'Phụ đề tiếng Việt', 'admin'),
    (4, 1, '2026-07-03', '22:00:00', 'Lòng tiếng', 'admin'),
    (2, 1, '2026-07-04', '08:00:00', 'Phụ đề tiếng Việt', 'admin'),
    (3, 1, '2026-07-04', '10:00:00', 'Phụ đề tiếng Việt', 'admin'),
    (4, 1, '2026-07-04', '12:00:00', 'Lòng tiếng', 'admin'),
    (5, 1, '2026-07-04', '14:00:00', 'Phụ đề tiếng Anh', 'admin'),
    (6, 1, '2026-07-04', '16:00:00', 'Phụ đề tiếng Việt', 'admin'),
    (2, 1, '2026-07-04', '18:00:00', 'Phụ đề tiếng Việt', 'admin'),
    (3, 1, '2026-07-04', '20:00:00', 'Phụ đề tiếng Việt', 'admin'),
    (4, 1, '2026-07-04', '22:00:00', 'Lòng tiếng', 'admin'),
    (2, 1, '2026-07-05', '08:00:00', 'Phụ đề tiếng Việt', 'admin'),
    (3, 1, '2026-07-05', '10:00:00', 'Phụ đề tiếng Việt', 'admin'),
    (4, 1, '2026-07-05', '12:00:00', 'Lòng tiếng', 'admin'),
    (5, 1, '2026-07-05', '14:00:00', 'Phụ đề tiếng Anh', 'admin'),
    (6, 1, '2026-07-05', '16:00:00', 'Phụ đề tiếng Việt', 'admin'),
    (2, 1, '2026-07-05', '18:00:00', 'Phụ đề tiếng Việt', 'admin'),
    (3, 1, '2026-07-05', '20:00:00', 'Phụ đề tiếng Việt', 'admin'),
    (4, 1, '2026-07-05', '22:00:00', 'Lòng tiếng', 'admin'),
    (5, 1, '2026-07-05', '14:00:00', 'Phụ đề tiếng Anh', 'admin'),
    (6, 1, '2026-07-05', '16:00:00', 'Phụ đề tiếng Việt', 'admin'),
    (2, 1, '2026-07-06', '08:00:00', 'Phụ đề tiếng Việt', 'admin'),
    (3, 1, '2026-07-06', '10:00:00', 'Phụ đề tiếng Việt', 'admin'),
    (4, 1, '2026-07-06', '12:00:00', 'Lòng tiếng', 'admin'),
    (5, 1, '2026-07-06', '14:00:00', 'Phụ đề tiếng Anh', 'admin'),
    (6, 1, '2026-07-06', '16:00:00', 'Phụ đề tiếng Việt', 'admin'),
    (2, 1, '2026-07-06', '18:00:00', 'Phụ đề tiếng Việt', 'admin'),
    (3, 1, '2026-07-06', '20:00:00', 'Phụ đề tiếng Việt', 'admin'),
    (4, 1, '2026-07-06', '22:00:00', 'Lòng tiếng', 'admin'),
    (5, 1, '2026-07-06', '14:00:00', 'Phụ đề tiếng Anh', 'admin'),
    (6, 1, '2026-07-06', '16:00:00', 'Phụ đề tiếng Việt', 'admin'),
    (2, 1, '2026-07-07', '08:00:00', 'Phụ đề tiếng Việt', 'admin'),
    (3, 1, '2026-07-07', '10:00:00', 'Phụ đề tiếng Việt', 'admin'),
    (4, 1, '2026-07-07', '12:00:00', 'Lòng tiếng', 'admin'),
    (5, 1, '2026-07-07', '14:00:00', 'Phụ đề tiếng Anh', 'admin'),
    (6, 1, '2026-07-07', '16:00:00', 'Phụ đề tiếng Việt', 'admin'),
    (2, 1, '2026-07-07', '18:00:00', 'Phụ đề tiếng Việt', 'admin'),
    (3, 1, '2026-07-07', '20:00:00', 'Phụ đề tiếng Việt', 'admin'),
    (4, 1, '2026-07-07', '22:00:00', 'Lòng tiếng', 'admin'),
    (5, 1, '2026-07-07', '14:00:00', 'Phụ đề tiếng Anh', 'admin'),
    (6, 1, '2026-07-07', '16:00:00', 'Phụ đề tiếng Việt', 'admin');
...
insert into showtime(movie_id, hall_id, date, start_time, type, created_by)
    value
    (3, 2, '2026-07-04', '08:00:00', 'Phụ đề tiếng Việt', 'admin'),
    (4, 2, '2026-07-04', '10:00:00', 'Phụ đề tiếng Việt', 'admin'),
    (5, 2, '2026-07-04', '12:00:00', 'Lòng tiếng', 'admin'),
    (6, 2, '2026-07-04', '14:00:00', 'Phụ đề tiếng Anh', 'admin'),
    (7, 2, '2026-07-04', '16:00:00', 'Phụ đề tiếng Việt', 'admin'),
    (8, 2, '2026-07-04', '18:00:00', 'Lòng tiếng', 'admin'),
    (3, 2, '2026-07-04', '20:00:00', 'Phụ đề tiếng Việt', 'admin'),
    (4, 2, '2026-07-04', '22:00:00', 'Phụ đề tiếng Việt', 'admin'),
    (3, 2, '2026-07-05', '08:00:00', 'Phụ đề tiếng Việt', 'admin'),
    (4, 2, '2026-07-05', '10:00:00', 'Phụ đề tiếng Việt', 'admin'),
    (5, 2, '2026-07-05', '12:00:00', 'Lòng tiếng', 'admin'),
    (6, 2, '2026-07-05', '14:00:00', 'Phụ đề tiếng Anh', 'admin'),
    (7, 2, '2026-07-05', '16:00:00', 'Phụ đề tiếng Việt', 'admin'),
    (8, 2, '2026-07-05', '18:00:00', 'Lòng tiếng', 'admin'),
    (3, 2, '2026-07-05', '20:00:00', 'Phụ đề tiếng Việt', 'admin'),
    (4, 2, '2026-07-05', '22:00:00', 'Phụ đề tiếng Việt', 'admin'),
    (3, 2, '2026-07-06', '08:00:00', 'Phụ đề tiếng Việt', 'admin'),
    (4, 2, '2026-07-06', '10:00:00', 'Phụ đề tiếng Việt', 'admin'),
    (5, 2, '2026-07-06', '12:00:00', 'Lòng tiếng', 'admin'),
    (6, 2, '2026-07-06', '14:00:00', 'Phụ đề tiếng Anh', 'admin'),
    (7, 2, '2026-07-06', '16:00:00', 'Phụ đề tiếng Việt', 'admin'),
    (8, 2, '2026-07-06', '18:00:00', 'Lòng tiếng', 'admin'),
    (3, 2, '2026-07-06', '20:00:00', 'Phụ đề tiếng Việt', 'admin'),
    (4, 2, '2026-07-06', '22:00:00', 'Phụ đề tiếng Việt', 'admin'),
    (3, 2, '2026-07-07', '08:00:00', 'Phụ đề tiếng Việt', 'admin'),
    (4, 2, '2026-07-07', '10:00:00', 'Phụ đề tiếng Việt', 'admin'),
    (5, 2, '2026-07-07', '12:00:00', 'Lòng tiếng', 'admin'),
    (6, 2, '2026-07-07', '14:00:00', 'Phụ đề tiếng Anh', 'admin'),
    (7, 2, '2026-07-07', '16:00:00', 'Phụ đề tiếng Việt', 'admin'),
    (8, 2, '2026-07-07', '18:00:00', 'Lòng tiếng', 'admin'),
    (3, 2, '2026-07-07', '20:00:00', 'Phụ đề tiếng Việt', 'admin'),
    (4, 2, '2026-07-07', '22:00:00', 'Phụ đề tiếng Việt', 'admin');
